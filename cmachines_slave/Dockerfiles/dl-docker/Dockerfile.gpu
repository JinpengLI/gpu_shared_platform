...
RUN cd /root && git clone https://github.com/facebook/iTorch.git && cd iTorch && luarocks make
...
RUN apt-get install -y tmux screen wget
...
RUN cd /root/ && cat add_bashrc >> .bashrc && rm add_bashrc
